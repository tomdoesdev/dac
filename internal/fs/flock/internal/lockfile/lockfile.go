// Package lockfile implements the flock package.
// The flock package is the API. This package is the code behind it.
package lockfile
...
// It returns ErrLocked when another holder has the lock.
...
// Release unlocks that file. Release does not close it.
